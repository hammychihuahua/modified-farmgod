  ...
  const msg = {
    nl_NL: {
      ...
      options: {
        ...
        warning:
          '<b>Waarschuwingen:</b><br>- Zorg dat A is ingesteld als je standaard microfarm en C als een grotere microfarm<br>- Zorg dat de farm filters correct zijn ingesteld voor je het script gebruikt',
        filterImage:
        ...
        maxloot: 'Verstuur een C farm als de buit vorige keer vol was:',
    ...
    hu_HU: {
      ...
      options: {
        ...
        warning:
          '<b>Figyelem:</b><br>- Bizonyosodj meg rÃ³la, hogy az "A" sablon az alapÃ©rtelmezett Ã©s a "C" egy nagyobb mennyisÃ©gÅ± mikrÃ³-farm<br>- Bizonyosodj meg rÃ³la, hogy a farm-filterek megfelelÅ‘en vannak beÃ¡llÃ­tva mielÅ‘tt hasznÃ¡lod a sctiptet',
        filterImage:
        ...
        maxloot:
          'A "C" sablont kÃ¼ldje abban az esetben, ha az elÅ‘zÅ‘ tÃ¡madÃ¡s maximÃ¡lis fosztogatÃ¡ssal jÃ¡rt:',
    ...
    int: {
      ...
      options: {
        ...
        warning:
          '<b>Warning:</b><br>- Make sure A is set as your default microfarm and C as a larger microfarm<br>- Make sure the farm filters are set correctly before using the script',
        filterImage:
          'https://higamy.github.io/TW/Scripts/Assets/farmGodFilters.png',
        ...
        maxloot: 'Send a C farm if the last loot was full:',
  ...
  const createPlanning = function (
    ...
    for (let prop in data.villages) {
      ...
      orderedFarms.forEach((el) => {
        ...
        // แก้ไขบรรทัดนี้: เปลี่ยนจาก 'b' เป็น 'c' 
        let template_name =
          optionMaxloot &&
